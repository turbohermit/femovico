...
# These ones can be saved via UtilSave and will be loaded automatically on initialization.
...
func save():
	var success = UtilSave.serialize_model(self)
	if not success:
...
func load_from_disk() -> bool:
	return UtilSave.load_saveable(self)
